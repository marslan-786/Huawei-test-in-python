...
async def solve_captcha(page, session_id, logger=print):
    ...
    # --- 🔥 ADJUSTMENT: INCREASE PADDING ---
    # Previous: 10. New: 25. 
    # This pushes the start Y down to avoid the "Please complete" white margin.
    top_pad = 25 
    bot_pad = 10
    ...
    logger(f"📏 Grid Calculated: W={int(grid_width)}, H={int(grid_height)}")
